...
//    /// <param name="data">Данные для рендеринга.</param>
//    /// <returns>Отрендеренный HTML.</returns>
...
//    /// <summary>
//    /// Рендерит шаблон из файла с использованием объекта данных.
//    /// </summary>
...
//    /// <summary>
//    /// Рендерит шаблон из потока с использованием объекта данных.
//    /// </summary>
...
//            return value ?? match.Value; // Если значение не найдено, оставить как есть
//        });
...
//    /// <summary>
//    /// Обрабатывает условные выражения в шаблоне.
//    /// </summary>
//    /// <param name="template">Шаблон HTML.</param>
//    /// <param name="properties">Свойства объекта данных.</param>
//    /// <param name="model">Объект данных для рендеринга.</param>
//    /// <returns>Отрендеренный HTML.</returns>
...
//    /// <summary>
//    /// Проверяет, находится ли строка внутри условного выражения.
//    /// </summary>
//    /// <param name="content">Содержимое шаблона.</param>
//    /// <param name="check">Строка для проверки.</param>
//    /// <returns>True, если строка находится внутри условного выражения, иначе false.</returns>
