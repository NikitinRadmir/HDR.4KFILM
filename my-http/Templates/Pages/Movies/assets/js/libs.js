...
// 	titlesArr = ["Смотреть онлайн","Оценка"];
...
// 		$('.shtur li:has(.hidden-menu)').hover(function() {
// 			$(this).find('.hidden-menu').fadeToggle(200);
// 			$(this).toggleClass('menuactive');
// 		});	
// 	} else {
// 		$('body').on('click','.shtur li:has(.hidden-menu) > a',function() {
// 				$(this).parent().find('.hidden-menu').slideToggle(200);
// 				$(this).parent().toggleClass('menuactive');
// 				return false;
// 		});	
// 	};
// 	$('.shtur li:has(ul)').addClass('submenu');
   	
// 	$("body").on("click", "[data-ajaxc]:not(.current)", function(){
// 		var $castom = $(this).attr("data-ajaxc"),
// 			$targetBox = $(this).closest('.rzd123').children('.rzd123-c');
...
// 			mouseenter: function () {
// 				var shortV = $(this),
// 					shortIn = shortV.closest('.krat123'),
// 					sUrl = shortIn.find('.krat123-poster').attr('href'),
// 					sText = shortIn.find('.krat123-text'),
// 					winWidth = window.innerWidth,
// 					sPos = shortIn.offset().left;
// 				if (sPos > winWidth/2) {
// 					shortIn.addClass('pop-left');
// 				};
// 				shortIn.addClass('krat123-active').find('.krat123-text').fadeIn(200);
// 				if ( shortIn.hasClass('nl') ) {
// 					$.ajax({
// 						url: sUrl,
// 						beforeSend: function() { shortIn.removeClass('nl'); },			 
// 						success: function(data) {
// 							sText.append($('#s-title', data)).append($('#s-db', data)).append($('#s-desc', data)).append($('#s-list', data));
// 							sText.append('<a class="button sl-link icon-l" href="'+sUrl+'"><span class="fa fa-play-circle-o"></span>'+titlesArr[0]+'</a>');
// 							shortIn.removeClass('nl2');
// 						},
// 						  error: function() {
// 							console.log('error');
// 						  }
...
// 			},
// 			mouseleave: function () {
// 				$(this).closest('.krat123').removeClass('krat123-active').find('.krat123-text').fadeOut(0);
// 			}
// 		},'.krat123-view');
// 	};
...
// 	$('.frate').each(function(){
//         var a = $(this),
// 			aVotes = a.children('.fr-votes'),
// 			b = parseInt(aVotes.find('.ratingtypeplusminus').text()),
// 			c = parseInt(aVotes.find('span[id]:last').text());
//         if ( c >= b && c > 0) {
// 			var m = (c - b)/2,
// 				p = c - m,
// 				pTen = (Math.round((c - (c - b)/2)/c*100))/10,
// 				mTen = 10 - pTen;
//         } else {
// 			var m = 0, 
// 				p = 0,
...
// 		a.find('.fr-common').append('<div>'+pTen+'<div>'+titlesArr[1]+'</div></div>');
// 		a.find('.fr-plus').circleProgress({
// 			  size: 60.0,
// 			  startAngle: -1.5,
// 			  lineCap: 'round',
// 			  value: pTen/10,
// 			  emptyFill:'#f5f5f5',
// 			  fill: {gradient: ['#2dc225', '#33a42d']}
// 		});
// 		a.find('.fr-minus').circleProgress({
// 			  size: 60.0,
// 			  startAngle: -1.5,
// 			  lineCap: 'round',
// 			  value: mTen/10,
// 			  emptyFill:'#f5f5f5',
// 			  fill: {gradient: ['#f4470b', '#dd4d1b']}
// 		});
// 		$('.fr2-site .frate2-count').html(pTen);
//     });	
...
// 					m = (data.votenum - rt)/2,
// 					p = data.votenum - m,
// 					pTen = (Math.round((data.votenum - (data.votenum - rt)/2)/data.votenum*100))/10,
// 					mTen = 10 - pTen,
// 					fRate = $("#frate-" + id);
// 				fRate.find('.psc').text(p);
// 				fRate.find('.msc').text(m);
// 				fRate.find('.fr-common').html('<div>'+pTen+'<div>'+titlesArr[1]+'</div></div>');
// 				fRate.find('.fr-plus').circleProgress({
// 					value: pTen/10
// 				});
// 				fRate.find('.fr-minus').circleProgress({
// 					value: mTen/10
// 				});
// 			$('.fr2-site .frate2-count').html(pTen);
