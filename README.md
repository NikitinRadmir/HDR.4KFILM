...
6.ПРОСЬБА!!! не удалять уже готовые данные таблиц. Если вы хотите попробовать Docker Compose откройте ветку backlog1, а если хотите без то используйте ветку backlog
